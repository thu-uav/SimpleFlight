...
init_hover_thrust = torch.ones_like(sim_target_thrust) * 0.5828
...
start_T_real = 500
end_T_real = 500 + 700
df = pd.read_csv('/home/jiayu/OmniDrones/real2sim/DATT/scale2_5_smooth5/fast_200Hz/cf14_fast_200Hz.csv', skip_blank_lines=True)
