...
max_thrust = 0.9
# sim data
sim_target = torch.load('/home/jiayu/OmniDrones/real2sim/fast/0_0to0_8/sim_action.pt')
sim_real = torch.load('/home/jiayu/OmniDrones/real2sim/fast/0_0to0_8/sim_rpy.pt')
...
# start_T_real = 500
# end_T_real = 500 + 700
# df = pd.read_csv('/home/jiayu/OmniDrones/real2sim/DATT/scale2_5_smooth5/fast_200_long/cf14_fast_200Hz.csv', skip_blank_lines=True)
