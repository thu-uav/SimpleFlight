...
data = torch.load('/home/jiayu/OmniDrones/real2sim/DATT/scale2_5_smooth5/sim_state.pt')
...
if trajectory_scale == 'slow':
    ...
    vel_range = 3.0
real_data = torch.load('/home/jiayu/OmniDrones/real2sim/DATT/scale2_5_smooth5/real_state.pt')
real_obs = []
